...
$(document).ready(function(){
     ...
     $("#btnSearch").click(function(){
  		 $("audit").val("1");
         $("#form").attr("action", "rlgl021130Search.action");
         $("#form").submit();
     });
      //单位性质级联
        ...
        <td>
         <!-- 内容显示区域 -->
          ...
          <form  id="form" nameSpace="/rlgl" action="doLogin" method="post" >
              ...
              <s:hidden name="rlgl021115Bean.audit_kbn" id="audit_kbn"/>
              <s:hidden name="audit" id="audit"/>
              <s:hidden name="rlgl021116Bean.audit_kbn" id="audit_kbn1"/>
