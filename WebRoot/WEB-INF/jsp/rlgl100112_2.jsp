				...
				<div style="height: 150px;" class="content">
					<form id="rlgl100104form" nameSpace="/rlgl" action="doLogin"
						...
						<table width="100%" border="1px">
							<tr>
								<td colspan="9" align="left">公共课程报名列表&nbsp;&nbsp;&nbsp;&nbsp;
									<!-- <input type="button" id="btn_cancel" value="取消课程" class="inp_L3"></input> -->
								</td>
							</tr>
							<tr>
								...
								<th class='thTitleItrn'>学习要求</th>
								<th class='thTitleItrn'>报名截止日期</th>
<!-- 								<th class='thTitleItrn'>学分</th> -->
								<th class='thTitleItrn'>价格</th>
								<th class='thTitleItrn'>拟起止日期</th>
							...
							<s:iterator value="courseSelectedList" status="L" var="course">
								<my:trStripe index="${L.index}">
									...
									<td class='tbl'><s:property value='bixiu_flag' /></td>
...
<%-- 												value='xuefen' />(分)</span></td> --%>
									<td class='tbl'><s:property value='course_price' /></td>
									<td class='tbl'><s:property value='expend_01' /></td>
									<td class='tdc'><s:if test="is_prep==0">
											<input class="inp_L3 btnClass_${only_search}" type="button"
												id="butLearn" disabled="disabled" value="报&nbsp;&nbsp;名"
