	...
	%>
       <script type="text/javascript" language="javascript"> 
			...
			{   if(objectArray==""){
				...
				$("#changedObject").val(objectArray);
				$("#addFlg").val("addFlg2");
				$("form").attr("action", "rlgl010306XingzhengChange.action");
				$("form").submit();
			} 
		    ...
		    function doSaveAction() {
		      		if(checkItems() == true){
						...
						$("#changedObject").val(objectArray);
					    $("#saveAction").val("1");
					    $("form").attr("action", "rlgl010306XingzhengAdd.action");
					    $("form").submit();
		      		}		    			
		    }
    ...
    <div >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td height="30" align="right">
              <input type="button" class="am-btn am-btn-primary" onClick="addNewXzzwxx('tab_xzzwxx')" width="100px" value="行追加" name="btn_Add"/>
              &nbsp;&nbsp;&nbsp;&nbsp;
