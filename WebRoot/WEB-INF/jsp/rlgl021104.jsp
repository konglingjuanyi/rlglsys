...
$(document).ready(function(){
     ...
     $("#btnSearch").click(function(){
         $("#form").attr("action", "rlgl021104Search.action");
         $("#form").submit();
     });
     
});
function auditBut(project_no)
{
   $("#project_no").val(project_no);
   $("#form").attr("action", "rlgl021105Init.action");
   $("#form").submit();
}
</script>
     <TITLE>
          ...
          <form  id="form" nameSpace="/rlgl" action="doLogin" method="post" >
	          ...
	          <caption>查询条件</caption>
	            <tr> 
	              ...
	              <td class='lc2'><s:textfield  name="rlgl021104Bean.project_no"  style="width:150px"/></td>
	              <td class='lc1'>项目名称</td>
	              <td class='lc2'><s:textfield  name="rlgl021104Bean.project_nm"  style="width:150px"/></td>
	              ...
	              <my:trStripe index="${L.index}">
	                ...
	                <td  class="tbl" >
	                 ...
	                 <td class="tdc" width="10%">
	                   <input type="button" class="inp_L3 btnClass_${only_search}" value="审核"  onclick="auditBut('<s:property value='project_no'/>')"/>
	                 </td>
	              </my:trStripe>
              </s:iterator>
          </table>
