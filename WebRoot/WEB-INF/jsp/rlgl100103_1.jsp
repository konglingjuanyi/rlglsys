...
<s:hidden name="screenId" id="screenId"/>
    ...
    <frame name="navi" src="naviInit_jn.action" frameborder="0" scrolling="no" noresize>
      <frameset name="pageframe" id="pageframe" cols="180,*" frameborder="no">
         <frame name="coursware" src="coursware_jn.action" frameborder="0" scrolling="auto" noresize>
         <frame name="contents1" src="coursInit_jn.action" frameborder="0" scrolling="auto" noresize>
      </frameset>
  </frameset>
</html>
