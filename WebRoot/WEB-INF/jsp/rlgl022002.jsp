...
$(document).ready(function(){
     $(".admsearch").click(function(){
        ...
        $("form").attr("action", "coursInit.action");
  ...
  <body>
   <s:form  action="courswareInit" nameSpace="/rlgl" target="contents1" method="POST">
		...
		<table width="100%" style="position: relative;"  class=" am-table am-table-bordered am-table-radius am-table-striped am-table-hover "
				...
				<thead>
				<tr>
					<th  colspan="2">&nbsp;&nbsp;&nbsp;培训课程列表：1</th>
				</tr>
				</thead>
			<s:iterator value="courseList" status="L">
			   <tr >
			    <td><a href="#" style="font-size:12px"><s:property value='adm_name'/></a><s:hidden name="adm_num"/></td>
			   </tr>
			</s:iterator>
		</table>
	</s:form>
