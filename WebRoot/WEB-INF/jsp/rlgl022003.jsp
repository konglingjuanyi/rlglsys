   ...
   var sum=0;
    ...
    <body>
		  <div class="content">
	          ...
	          <!-- 数据检索条件 -->  
	          <form name="form"  id="rlgl022003form" nameSpace="/rlgl" target="contents1"  method="post" >
	              <s:hidden name="user_id" id="user_id"/>
	              <s:hidden name="course_catagory" id="course_catagory"/>
	              <my:dividepage actionId="coursInit.action"></my:dividepage>
		          <table style="width:99%;valign:top" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover" >
		              ...
		              <s:iterator value="courseList" status="L">
			              ...
			              <my:trStripe index="${L.index}">
			                ...
			                <td class='tdc'>
			                  <s:checkbox name="ishere" id="select_kbn_check" cssClass="ishere" fieldValue="%{#L.index }" />
			                </td>
			              </my:trStripe>
		              </s:iterator>
		          </table>
