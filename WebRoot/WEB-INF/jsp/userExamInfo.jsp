                 ...
                 <th height="28" width="10%" class="thTitleItrn">工作单位</th>
                  <th height="28" width="10%" class="thTitleItrn">单位编号</th>
                   <th height="28" width="10%" class="thTitleItrn">所属区县</th>
                    <th height="28" width="10%" class="thTitleItrn">考试报名课程</th>
                     <th height="28" width="10%" class="thTitleItrn">学分</th>
                      <th height="28" width="10%" class="thTitleItrn">报名日期</th> 
                  <th height="28" width="10%" class="thTitleItrn">考试获取学分</th>
               <th height="28" width="10%" class="thTitleItrn">考试日期</th>
              </tr>
                       ...
                       <td height="20" class="tdl"><s:property value='USER_ID'/></td>
                         ...
                         <td height="20" class="tdl"><s:property value='Unit_NO'/></td>
                          ...
                          <s:property value='ZONE'/>
                           ...
                           <td height="20" class="tdl"><s:property value='COURSE_NAME'/></td>
                            <td height="20" class="tdl"><s:property value='XUEFEN'/></td>
                             <td height="20" class="tdl"><s:property value='UPDATE_DATE'/></td>
                              <td height="20" class="tdl"><s:property value='CREDIT'/></td>
                               <td height="20" class="tdl"><s:property value='EXAMS_TIME'/></td>
                          </tr>
