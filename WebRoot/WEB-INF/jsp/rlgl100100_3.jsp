...
<script language="JavaScript">
	...
	$(document).ready(function() {
		$("#btnSearch").click(function() {
			...
			$("#form").attr("action", "rlgl100100_3InitSerach.action");
			$("#form").attr("namespace", "/rlgl");
			$("#form").submit();
		});
		$("#btnDaoChu").click(function() {

			$("#form").attr("action", "rlgl100100_1export.action");
			$("#form").attr("namespace", "/rlgl");
			$("#form").submit();
		});
	});
		...
		<div class="content">
			...
			<s:if test="%{playFlag==1}">
				...
				<div id="result" style="position: relative; top: 15px">
					<my:dividepage actionId="rlgl100100_3InitSerach.action"></my:dividepage>
					<table width="100%" style="position: relative; top: 10px;"
						...
						<tr>
							...
							<th height="28" width="5%" class="thTitleItrn">消费金额</th>
							<th height="28" width="15%" class="thTitleItrn">消费项目内容</th>
						...
						<s:iterator value="tb02PrepayMsgList" status="L">
							<my:trStripe index="${L.index}">
								...
								<td height="20" class="tdc"><s:property value='MerchantNM' /></td>
								<td height="20" class="tdc"><s:property value='pay_year' /></td>
							</my:trStripe>
						</s:iterator>
					</table>
				</div>
