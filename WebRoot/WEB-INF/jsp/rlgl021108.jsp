...
$(function(){
	...
	$(document).ready(function(){
	    $("#btnConfirm").click(function(){
	         ...
	         if(checkvalue){
	         $("#form").attr("action", "rlgl021102Update.action");
...
function clearNoNum(obj) {
  ...
  <body><div>
  <s:form id="form" name="form" method="post" action="rlgl021102Update" nameSpace="/rlgl">
      ...
      <my:message></my:message>
       <div style="position: relative">
        ...
        <tr>
            ...
            <td><s:textfield name="mtb91Info.unit_no" value='%{mtb91Info.unit_no}' readonly="true"></s:textfield>
             <s:hidden value='%{mtb91Info.arrly_no}' name="mtb91Info.arrly_no"></s:hidden>
            </td>
            <td width="15%" class="lc1">单位名称：<font color="red">*</font></td>
            <td>
             <s:textfield name="mtb91Info.unit_nm" value='%{mtb91Info.unit_nm}' readonly="true"></s:textfield>
            </td>
          </tr>
          <tr>
            <td width="15%" class="lc1">项目名称：<font color="red">*</font></td>
            <td>
              <s:textfield id="project_nm" name="mtb91Info.project_nm" value='%{mtb91Info.project_nm}' cssClass="put" maxLength="38" cssStyle="width:150px"></s:textfield>
            </td>
            <td width="15%" class="lc1">讲授人：<font color="red">*</font></td>
            <td>
              <s:textfield id="teach_people" name="mtb91Info.teach_people"  value='%{mtb91Info.teach_people}' cssClass="put" maxLength="24"></s:textfield>
            </td>
          </tr>
          <tr>
            <td width="15%" class="lc1">讲授地点：<font color="red">*</font></td>
            <td>
              <s:textfield id="teach_place" name="mtb91Info.teach_place" value='%{mtb91Info.teach_place}' cssClass="put" maxLength="24" cssStyle="width:150px"></s:textfield>
            </td>
            <td width="15%" class="lc1">总学时：<font color="red">*</font></td>
            <td>
              <s:textfield id="total_hours" name="mtb91Info.total_hours" value='%{mtb91Info.total_hours}' cssClass="put" maxLength="3" onkeyup="clearNoNum(this)"></s:textfield>小时
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
             <sx:datetimepicker  type="date" name="mtb91Info.teach_start_date"  value='%{mtb91Info.teach_start_date}' displayFormat="yyyy-MM-dd" id="teach_start_date"
            ></sx:datetimepicker>
            <td width="15%" class="lc1">开始时间：<font color="red">*</font></td>
            <td>
            <s:textfield id="example_2" name="mtb91Info.teach_start_time" value='%{mtb91Info.teach_start_time}'/></td>
<!--             <sx:datetimepicker id="teach_start_time" type="time" name="mtb91Info.teach_start_time" value='%{mtb91Info.teach_start_time}' displayFormat="HH:mm" 
            ></sx:datetimepicker> -->
          </tr>
          <tr>
            <td width="15%" class="lc1">结束日期：<font color="red">*</font></td>
            <td>
              <sx:datetimepicker  type="date" name="mtb91Info.teach_end_date"  value='%{mtb91Info.teach_end_date}' displayFormat="yyyy-MM-dd" id="teach_end_date"
            ></sx:datetimepicker>
            <td width="15%" class="lc1">结束时间：<font color="red">*</font></td>
            <td>
            <s:textfield id="example_3" name="mtb91Info.teach_end_time" value='%{mtb91Info.teach_end_time}'/></td>
          </tr>
          <tr>
            <!-- <td width="15%" class="lc1">申请范围：<font color="red">*</font></td>
            <td>
             hello world
            </td> -->
          </tr>
          <tr>
           ...
           <s:if test="%{mtb91Info.audit_status == 0}">
            <input type="button" class="inp_L3 btnClass_${only_search}" value="提 交 " name="btnConfirm" id="btnConfirm" disabled="disabled">
            </s:if>
            <s:if test="%{mtb91Info.audit_status != 0}"> 
            <input type="button" class="inp_L3 btnClass_${only_search}" value="提 交 " name="btnConfirm" id="btnConfirm">
            </s:if>
            <%-- <input type="button" class="inp_L3 btnClass_${only_search}" value="重 置" name="btnreset" id="btnreset"> --%>
