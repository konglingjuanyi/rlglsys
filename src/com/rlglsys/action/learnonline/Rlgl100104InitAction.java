...
public class Rlgl100104InitAction extends BaseAction{
	...
	try {
        ...
        rlgl100104Bean.setXuefen_leibie("001");
        //获取年度用变量
        ...
        rlgl100104Bean.setCredit_year(credit_year);
    		courseSelectedList=rlgl100104Service.selectCourseSelected(rlgl100104Bean);
